        ...
        <div className="Section3__Main">
            <div className="Section3__Box3">
                <div className="Section3__Box1">
                    <h4><strong>Become a Coach</strong></h4>
            ...
            <div className="Section3__Box2">
                <h4><b>Strength</b></h4>
                <p>Starts</p>
                <h1><b>$10</b><span className="Section3__pricemini">/mo</span></h1>
                <ul>
                <li>Principle</li>
            ...
            <div className="Section3__Box2">
                <h4 style={{"fontSize":"20px"}}><b>MentalHealth + Fitness</b></h4>
                <p>Starts</p>
                <h1><b>$25</b><span className="Section3__pricemini">/mo</span></h1>
                <ul>
                <li>Principle</li>
                <li>Calculate stress</li>
            ...
            <h4><b>Platinum</b></h4>
                <p>Starts</p>
                <h1><b>$30</b><span className="Section3__pricemini">/mo</span></h1>
                <ul>
                <li>Principle</li>
                <li>Calculate stress</li>
                <li>Physical Education</li>
